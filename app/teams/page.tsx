  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 opacity-20 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-[500px] bg-linear-to-b from-blue-600/30 via-purple-600/20 to-transparent" />
        <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-linear-to-tl from-pink-600/20 to-transparent rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-500/20 to-purple-500/20 rounded-full border border-blue-500/30 mb-6 backdrop-blur-sm">
            <Trophy className="w-4 h-4 text-blue-400" />
            <span className="text-sm text-foreground">FIFA World Cup 2026</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 text-sm">
            ...
            {(filters.search || filters.group) && (
              <motion.div
                ...
                className="border border-slate-800 px-6 py-3 rounded-full backdrop-blur-sm"
              >
                <span className="font-semibold text-foreground">
